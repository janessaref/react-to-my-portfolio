...
function Contact() {
    return(
        <React.Fragment>
            ...
            <div className="col-sm-12 col-md-9 col-lg-9 p-5 rounded">
                <div className="card cardPage" styles="max-width: 100%; opacity:.9">
                    <div className="card-body">
                        <h2 className="card-title text-info font-weight-bold" styles="font-family: 'DM Serif Text', serif;">Contact</h2>
                        <hr/>
                        <div className="row">
            ...
            <div className="row ml-4 w-100 mr-5 text-center" styles="padding-bottom: 100px;">
                <div className="col-sm-12 col-md-9 col-lg-9 rounded">
                    <div className="card ml-2 contactPage" styles="max-width: 100%; opacity:.9">
                        <div className="card-body">
                            <div class="row mx-auto h-auto w-auto">
                                <div className="col-lg-12 mx-auto h-auto w-auto">
                                    ...
                                    <a href="tel:9256983569 " styles="color:black" className="mr-2">(925) 698-3569 
                                    </a>
                                    <strong>|</strong>
                                    ...
                                    <a href="mailto:janessarefong@gmail.com " styles="color:black" className="ml-2">Email Me</a>
